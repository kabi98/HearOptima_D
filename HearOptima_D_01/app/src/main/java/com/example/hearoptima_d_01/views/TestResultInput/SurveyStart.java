...
public class SurveyStart extends AppCompatActivity {
    ...
    String[] quizQuestions = {
            "질문1. 어느 상황이든 1:1 대화에 지장이 있습니다.",
            "질문2. 3-5m 떨어진 곳에서 대화하거나 집단으로 대화할 때 보통의 회화 청취가 곤란합니다.",
            "질문3. 1m 정도 떨어진 곳에서의 큰 소리는 알아들을 수 없습니다.",
            "질문4. 군중 속이나 강의실에서는 언어 이해가 곤란합니다.",
            "질문5. 귀 가까이에서 말하지 않으면 알아들을 수 없습니다.",
            "질문6. 매우 큰 소리에만 반응하며, 언어의 이해는 거의 불가능합니다.",
            "질문7. 폭발음 등만 들을 수 있고 상당히 큰 소리도 들을 수 없습니다."
    };
