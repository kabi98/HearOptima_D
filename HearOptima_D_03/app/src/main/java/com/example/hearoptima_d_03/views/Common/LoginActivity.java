...
import com.example.hearoptima_d_03.db.AccountDAO;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    ImageButton m_AppBtnJoin, m_AppBtnIdFind, m_AppBtnPwFind;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        m_AppBtnIdFind = findViewById(R.id.id_findbtn);
        m_AppBtnIdFind.setOnClickListener(this);

        m_AppBtnPwFind = findViewById(R.id.pw_findbtn);
        m_AppBtnPwFind.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        } else if (view.getId() == R.id.id_findbtn) {
            Intent intent = new Intent(getApplicationContext(), IdPwFindActivity.class);
            startActivity(intent);
        } else if (view.getId() == R.id.pw_findbtn) {
            Intent intent = new Intent(getApplicationContext(), IdPwFindActivity.class);
            startActivity(intent);
        }
    }
